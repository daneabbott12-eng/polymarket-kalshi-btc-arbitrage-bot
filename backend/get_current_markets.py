...
def get_current_market_urls(poly_word="bitcoin", kalshi_series="kxbtcd"):
    """
    ...
    polymarket_url = generate_polymarket_url(target_time, poly_word)
    ...
    kalshi_url = generate_kalshi_url(kalshi_target_time, kalshi_series)
